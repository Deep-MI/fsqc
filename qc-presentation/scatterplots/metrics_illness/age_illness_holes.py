...
trace2 = go.Scatter(
    ...
    name = 'Number of defects for healthy subjects'
)
...
trace4 = go.Scatter(
    ...
    name='Number of defects for the slight Alzheimer disease subjects'
)
trace5 = go.Scatter(
    x=age_MCI_graph,
    y=line_MCI,
...
plotly.offline.plot(fig, filename = 'age-illness-holes-scatter.html')
