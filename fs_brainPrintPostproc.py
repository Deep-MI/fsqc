...
# Date:             Jul-18-2019
# Version:          1.0
# Comment:          Modularized design of the script; fs_brainPrintPostproc can
...
def options_parse():
    ...
    group.add_option('--outcov', dest='outcov', help=h_out, default=None)
    parser.add_option_group(group)
...
def fs_brainPrintPostproc(options):
