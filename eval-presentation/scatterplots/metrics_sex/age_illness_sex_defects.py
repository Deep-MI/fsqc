# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 12:13:02 2019
...
trace1 = go.Scatter(
    ...
    line = dict(
        color = ('rgb(0, 0, 255)'),
        width = 3),
    name='Linear fit for the male subjects'
)
...
trace3 = go.Scatter(
    ...
    line = dict(
        color = ('rgb(255, 0, 0)'),
        width = 3),
    name='Linear fit for the female subjects'
)
...
plotly.offline.plot(fig, filename = 'age-sex-defects-scatter.html')
