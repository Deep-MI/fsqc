...
for subject in ID_80_match: 
    nb_holes_80.append(cnr[sbj_fs.index(subject)])
...
for subject in ID_70_match: 
    nb_holes_70.append(cnr[sbj_fs.index(subject)])
...
for subject in ID_60_match: 
    nb_holes_60.append(cnr[sbj_fs.index(subject)])
...
for subject in ID_50_match: 
    nb_holes_50.append(cnr[sbj_fs.index(subject)])
