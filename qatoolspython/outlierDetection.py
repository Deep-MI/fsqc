...
def outlierTable():
    ...
    outlierDict = dict([
        ('Left-Accumbens-area',     dict([('mean' ,   509.6091023431), ('sd',  255.3576702622)])),
        ('Right-Accumbens-area',    dict([('mean' ,   536.8292541219), ('sd',  223.7429113041)])),
        ('Left-Amygdala',           dict([('mean' ,  1346.7573549195), ('sd',  380.9204342249)])),
        ('Right-Amygdala',          dict([('mean' ,  1365.6951800715), ('sd',  420.9326296839)])),
        ('Brain-Stem',              dict([('mean' , 16997.7430745096), ('sd', 3657.1478690755)])),
        ('Left-Caudate',            dict([('mean' ,  3188.8127849175), ('sd',  853.5816689255)])),
        ('Right-Caudate',           dict([('mean' ,  3017.2388990504), ('sd',  929.0249281701)])),
        ('Left-Hippocampus',        dict([('mean' ,  3639.3977943391), ('sd',  757.5026482920)])),
        ('Right-Hippocampus',       dict([('mean' ,  3625.6761542953), ('sd',  744.6170559887)])),
        ('Left-Pallidum',           dict([('mean' ,  1243.2988760927), ('sd',  460.1844875813)])),
        ('Right-Pallidum',          dict([('mean' ,  1333.4290920726), ('sd',  395.7811514099)])),
        ('Left-Putamen',            dict([('mean' ,  5199.9084328105), ('sd', 1324.1891523885)])),
        ('Right-Putamen',           dict([('mean' ,  4748.0423983620), ('sd', 1195.5103714010)])),
        ('Left-Thalamus-Proper',    dict([('mean' ,  6927.7566928780), ('sd', 1515.2832635261)])),
        ('Right-Thalamus-Proper',   dict([('mean' ,  6204.6848002925), ('sd', 1151.0914168195)])),
        ('Left-VentralDC',          dict([('mean' ,  3202.3856880955), ('sd',  661.9855654822)])),
        ('Right-VentralDC',         dict([('mean' ,  3249.1969199473), ('sd',  637.5855119944)])),
        ('Left-Lateral-Ventricle',  dict([('mean' ,  3070.2562410945), ('sd', 1779.0430005652)])),
        ('Right-Lateral-Ventricle', dict([('mean' ,  2800.1887579545), ('sd', 1629.7315789310)])),
        ('Left-Inf-Lat-Vent',       dict([('mean' ,   126.4224881060), ('sd',   90.6177444805)])),
        ('Right-Inf-Lat-Vent',      dict([('mean' ,   140.7914462122), ('sd',  103.1532053946)])),
        ('3rd-Ventricle',           dict([('mean' ,   514.6258578455), ('sd',  218.1140098856)])),
        ('4th-Ventricle',           dict([('mean' ,  1506.5993007538), ('sd', 1094.4819038702)]))
        ])
