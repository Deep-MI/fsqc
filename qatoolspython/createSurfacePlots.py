...
def createSurfacePlots(SUBJECT, SUBJECTS_DIR, SURFACES_OUTDIR, VIEWS):
    ...
    triaPialL = nb.freesurfer.read_geometry(os.path.join(SUBJECTS_DIR, SUBJECT, 'surf', 'lh.pial'))
    triaPialR = nb.freesurfer.read_geometry(os.path.join(SUBJECTS_DIR, SUBJECT, 'surf', 'rh.pial'))
    triaInflL = nb.freesurfer.read_geometry(os.path.join(SUBJECTS_DIR, SUBJECT, 'surf', 'lh.inflated'))
    triaInflR = nb.freesurfer.read_geometry(os.path.join(SUBJECTS_DIR, SUBJECT, 'surf', 'rh.inflated'))
