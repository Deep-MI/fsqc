...
def options_parse():
    ...
    parser.add_option('--python',     dest='python',     help=h_python,     default=False, action='store_true')
    ...
    if not options.python and not os.path.exists(sdna):
        parser.print_help()
