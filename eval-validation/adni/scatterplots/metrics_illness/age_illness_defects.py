# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 12:04:47 2019
...
trace1 = go.Scatter(
    ...
    line = dict(
        color = ('rgb(204, 0, 0)'),
        width = 3),
    name='Linear fit for the Alzheimer disease patients'
)
...
trace3 = go.Scatter(
    ...
    line = dict(
        color = ('rgb(102, 204, 0)'),
        width = 3),
    name='Linear fit for control subjects'
)
trace4 = go.Scatter(
    x = age_MCI_graph,
    y = holes_MCI_graph,
...
trace5 = go.Scatter(
    ...
    line = dict(
        color = ('rgb(255, 153, 0)'),
        width = 3),
    name='Linear fit mild cognitive disease subjects'
)
...
plotly.offline.plot(fig, filename = 'age-illness-defects-scatter.html')
'''
