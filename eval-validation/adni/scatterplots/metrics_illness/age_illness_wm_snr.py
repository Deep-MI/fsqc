...
#Get the holes data: 
wm_snr = data_fs.SNR_white_matter_norm.tolist()
wm_snr.pop(0)
...
trace0 = go.Scatter(
    ...
    name = 'White matter SNR for Alzheimer disease patients',
...
trace2 = go.Scatter(
    ...
    name = 'White matter SNR for healthy subjects'
)
...
trace4 = go.Scatter(
    ...
    name='White matter SNR for the slight Alzheimer disease subjects'
)
trace5 = go.Scatter(
    x=age_MCI_graph,
    y=line_MCI,
...
layout= go.Layout(
    title= 'White matter SNR over age and illness based on the norm.mgz image',
    hovermode= 'closest',
    xaxis= dict(
        title= 'Age',
        dtick=2,
...
plotly.offline.plot(fig, filename = 'age-illness-wm-snr-norm-scatter.html')
